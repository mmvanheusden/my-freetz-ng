...
Now this is where the annoying shit started happening. The `tools/push-firmware` didn't detect my FRITZ!Box in time.
...
![Flashing Freetz-NG to the FRITZ!Box 7560 from WSL](image.png)
